...
export default function GuidesPage() {
    ...
    return (
        <div className="relative min-h-screen bg-gray-900 text-white font-sans overflow-hidden">
            ...
            <main id="main-content" className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 space-y-8">
                {/* Page Header */}
                <header className="text-center">
                    <h1 className="text-3xl sm:text-4xl font-extrabold mb-4">Guides</h1>
                ...
                <section aria-labelledby="guides-list-title">
                    <h2 id="guides-list-title" className="sr-only">Guides List</h2>
                    <GuidesPageComponent />
                </section>
            </main>
