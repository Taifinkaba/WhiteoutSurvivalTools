...
interface PageCardProps {
    ...
    description: string;
    href: string;
    colorClass?: string; // Tailwind color for hover effects
    external?: boolean; // If true, opens in new tab
}

export default function PageCard({ title, description, href, colorClass = "green", external = false }: PageCardProps) {
